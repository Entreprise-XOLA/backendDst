    ...
    <q-page padding class="flex">
        ...
        <q-card style="flex:1; height: 400px;">
            ...
            <div class="row">
                ...
                <div class="col">
                    <q-btn  size="14px" style="background-color: blue; color: white; text-transform: none; margin-top: 20px; text-decoration:none;" glossy label="Retour au code" @click="commander"/>
                </div>
            </div>
            </center>
        </q-card>
...
<script>
    ...
    export default {
        ...
        mounted() {
            ...
            this.id_code = localStorage.getItem('id_code')
            ...
            this.$axios.get('http://vps732924.ovh.net/Neptune/index.php/GrandPublique/info_code?idcode=' + this.id_code)
                .then((response) => {
                    this.longitude = response.data.infos.longitude
                    this.latitude = response.data.infos.latitude
